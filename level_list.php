			...
			<div class="raw">
				 <div class="card card-info">
						<div class="card-header">
									...
									<h2 class="float-left">List Level</h2>

									<a href="add_level.php">  <button type="button"
									class="btn btn-light float-right" title="Collapse"> <i class="fas fa-plus text-dark">Add Level</i> </button> </a>
